    ...
    return (
        ...
        <div className="flex lg:flex-row flex-col lg:gap-0 gap-3 lg:p-0 p-[0.3rem] justify-between items-center mb-4">
          ...
          <div className="flex items-center space-x-6">
            <button className="bg-[#40464D] hover:bg-[#5a5e63] shadow-[inset_0px_2px_2px_0px_rgba(255,255,255,0.2),2px_3px_7px_0_rgba(0,0,0,0.8),-1px_-1px_4px_0_rgba(255,255,254,0.4)] text-[0.7rem] font-semibold text-white py-2 px-4 rounded-full">
              + ADD IMAGE
            </button>
